...
The flash loop is ArcX's core mechanism for leveraged points exposure. It works atomically: deposit USDC, sell the resulting ST on the ArcX AMM, re-deposit the proceeds, and repeat. Each iteration creates new EPT (which you keep) while recycling ST sale proceeds into more deposits.
