...
No new deposits can be made, but the EPT/USDC and ST/USDC orderbooks remain open for trading. Credit accrual is frozen as of the epoch end timestamp. The protocol waits for all positions to be closed and all capital to be settled before advancing.
