...
| **YT** (Yield Token) | **EPT** (Expected Points Token) | YT is **interest + points**. EPT is the **rewards side** — the yield has already been given to ST. |
...
ArcX isolates the rewards side into **EPT**, so points farmers do not need to pay for yield exposure they do not want.
...
In Pendle, the buyer is buying **interest + points** together through YT. To get exposure to 1 expected point, they are also paying for the yield stream:
...
So for the same capital, ArcX lets an EPT buyer get more concentrated expected-points exposure because they are not paying for the yield component.
