...
```mermaid
flowchart LR
    A["DEPOSIT<br/>Send USDC"] --> B["CHOOSE PATH<br/>Flash loop or hold"]
    B --> C["WAIT<br/>Epoch ends + settlement"]
    C --> D["REDEEM<br/>ST→USDC, EPT→Points"]
    D --> E["DECIDE<br/>Re-deposit or exit"]
    E --> A
```
...
The flash loop recycles your ST into more EPT:
...
**Result after 3 loops:** ~270 EPT from a \$100 starting deposit. Net outlay: ~\$27. Effective cost per EPT: **~\$0.10** instead of \$1.00.
